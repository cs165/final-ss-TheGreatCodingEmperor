...
async function onPatch(req, res) {
  ...
  while(rows[change_row][0]!==id){
    change_row++;
  }
  const content = Object.values(messageBody);
  console.log(messageBody);
  const newrow = [id,content[0]];
  rows[change_row][1]=messageBody;
...
app.patch('/api/:id', jsonParser, onPatch);
